package id.ac.polbeng.noviraasnani.gpsexample
...
import id.ac.polbeng.noviraasnani.gpsexample.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fusedLocationClient.lastLocation
            .addOnSuccessListener { location : Location? ->
                ...
                this can be null.
            logResultsToScreen("${location?.latitude},
                ${location?.longitude}")
            }
